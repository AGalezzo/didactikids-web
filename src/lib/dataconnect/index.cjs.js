...
const getOrdersByUserRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetOrdersByUser', inputVars);
}
getOrdersByUserRef.operationName = 'GetOrdersByUser';
exports.getOrdersByUserRef = getOrdersByUserRef;

exports.getOrdersByUser = function getOrdersByUser(dcOrVars, varsOrOptions, options) {
...
exports.getAllOrders = function getAllOrders(dcOrOptions, options) {
